...
<asp:Content ID="PageMainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <strong>Get Customers using Web References</strong>
    ...
    <strong>Get Customers using Ajax Call</strong>
    <div id="divCustomers"></div>
    <div id="divNoCustomers" class="hidden">
        <strong>Sorry! </strong>No Record(s) found.
    </div>
    ...
    <script type="text/javascript">
        function GetCustomerByAjax() {
            $.ajax({
                url: 'http://localhost:63976/CustomerService.asmx/GetCustomerByAjax',
                type: 'POST',
